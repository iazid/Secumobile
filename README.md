...
Interface graphique pour simuler 3 cyberattaques sur un système cible vulnérable : XSS, SQL Injection et DoS.
...
- **Scripts d'attaque** : XSS + DoS + SQL Injection(Jordan)
...
4. Sélectionner un type d'attaque (XSS / SQL Injection / DoS)
...
- **Jordan** : Scripts d'attaque SQL Injection + SQL Injection + DoS
